...
if dbconfig is None:
    raise ValueError("Database configuration not correctly set. Either place an appropriate configuration into the sea_src.db.database_configuration file or export GXDBHOST, GXDBPORT, GXDBUSER and GXDBPASS environment variables.")
